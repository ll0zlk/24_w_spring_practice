...
import com.example.practiceproject.service.CommentService;
...
public class ArticleController {
    ...
    public String delete(@PathVariable Long id, RedirectAttributes rttr) {      // RedirectAttributes 객체로 일회성 데이터 넘기기
        ...
        // 3. 결과 페이지로 리다이렉트하기
        return "redirect:/articles";        // index.mustache
    }
}
